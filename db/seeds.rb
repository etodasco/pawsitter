...
alexa = User.create!(nickname: "alexa", email: "alexa@test.ca", password: "test123", pet_sitter: true, description: "Experienced sitter with a love for dogs and cats.")
alexa.image.attach(io: File.open(Rails.root.join("app/assets/images/petsitters/alexa.jpg")), filename: "alexa.jpg")
maria = User.create!(nickname: "maria", email: "maria@test.ca", password: "test123", pet_sitter: true, description: "Professional pet sitter, happy to care for your pets while you're away!")
maria.image.attach(io: File.open(Rails.root.join("app/assets/images/petsitters/maria.jpg")), filename: "maria.jpg")
chris = User.create!(nickname: "chris", email: "chris@test.ca", password: "test123", pet_sitter: true, description: "Animal lover and expert in handling all types of pets.")
